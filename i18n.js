...
const translations = {
  ...
  ru: {
    ...
    'services.s4.li1':   'Заключение инвестиционных инструментов поддержки.',
  ...
  en: {
    ...
    'services.s4.li1':   'Execution of investment support instruments',
  ...
  kz: {
    ...
    'services.s1.li1':   'Жобаның іске асырылу мүмкіндігін жедел бағалау',
    'services.s1.li2':   'Тәуекелдер мен шектеулерді анықтау',
    'services.s1.li3':   'Мемлекеттік органдардың тарапынан қолдауды зондтау',
    ...
    'services.s3.li2':   'Техникалық шарттар аудиті',
    ...
    'services.s4.li1':   'Инвестициялық қолдау құралдары бойынша келісімдер жасау',
    ...
    'services.s5.li1':   'Келісімшарттық міндеттемелердің орындалуын бақылау',
    'services.s5.li2':   'Ағымдағы GR-кеңес беру',
    'services.s5.li3':   'Реттеуші тәуекелдерді анықтау және азайту',
    'services.s5.li4':   'Мемлекеттік органдармен және жергілікті қоғамдастықпен өзара іс-қимыл',
